...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Update', url='t.me/Anicomindex'),
      InlineKeyboardButton('Support', url='t.me/Anicom_chat')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('Tutorial', url='t.me/Anicom_chat'),
                   InlineKeyboardButton('Repo', url='t.me/Anicom_chat') ],
